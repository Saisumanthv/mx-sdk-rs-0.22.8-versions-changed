...
fn struct_with_numbers_static() {
    assert_eq!(
        <ManagedStructWithBigUint<DebugApi> as dharitri_wasm::types::ManagedVecItem<DebugApi>>::PAYLOAD_SIZE,
        8
    );
    assert!(
        !<ManagedStructWithBigUint<DebugApi> as dharitri_wasm::types::ManagedVecItem<DebugApi>>::SKIPS_RESERIALIZATION
    );
}
...
fn struct_to_bytes_writer() {
    ...
    let mut arr: [u8; 8] =
        [0u8; <ManagedStructWithBigUint<DebugApi> as dharitri_wasm::types::ManagedVecItem<
            DebugApi,
        >>::PAYLOAD_SIZE];

    <ManagedStructWithBigUint<DebugApi> as dharitri_wasm::types::ManagedVecItem<DebugApi>>::to_byte_writer(
        &s,
        |bytes| {
            arr[0..<ManagedStructWithBigUint::<DebugApi> as dharitri_wasm::types::ManagedVecItem<DebugApi>>::PAYLOAD_SIZE].copy_from_slice(bytes);
...
fn struct_from_bytes_reader() {
    ...
    let struct_from_bytes = <ManagedStructWithBigUint<DebugApi> as dharitri_wasm::types::ManagedVecItem<
        DebugApi,
    >>::from_byte_reader(DebugApi::dummy(), |bytes| {
        bytes.copy_from_slice(
                    &arr
                        [0
                            ..<ManagedStructWithBigUint::<DebugApi> as dharitri_wasm::types::ManagedVecItem<
                                DebugApi,
                            >>::PAYLOAD_SIZE],
                );
    });
